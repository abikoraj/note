        ...
        <div class="col-12 col-md-7 col-lg-6 auth-main-col text-center p-5">
            <div class="d-flex flex-column align-content-end">
                <div class="app-auth-body mx-auto">
                    ...
                    <h2 class="auth-heading text-center mb-5">Log in to Notes</h2>
                    <div class="auth-form-container text-start">
                        <form class="auth-form login-form" method="POST" action="{{ route('admin.login') }}">
                            @csrf
                            <div class="email mb-3">
                                <label class="sr-only" for="signin-email">Email</label>
                                <input name="email" type="email" class="form-control signin-email"
                        ...
                        <div class="auth-option text-center pt-5">No Account? Sign up <a class="text-link"
                                href="{{ route('admin.register') }}">here</a>.</div>
                    </div>
                    <!--//auth-form-container-->
                ...
                <footer class="app-auth-footer">
                    <div class="container text-center py-3">
                        ...
                        <small class="copyright">Developed by <a class="app-link"
                                href="http://needtechnosoft.com.np" target="_blank">Need Technosoft</a>
                        </small>
